  ...
  <section id="work" className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden mesh-gradient">
    <div className="max-w-7xl mx-auto relative z-10">
      <AnimatedWrapper animation="fade-up" className="text-center mb-16">
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-purple-600 mb-4">Portfolio</p>
            ...
            <div className="group glass-card rounded-3xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-2 h-full flex flex-col">
              ...
              <div className="p-8 flex flex-col flex-grow">
                <div className="flex items-start justify-between mb-6">
                  <div className={`p-3.5 rounded-2xl bg-gradient-to-br ${project.gradient} shadow-lg`}>
                    <project.icon className="h-6 w-6 text-white" />
                  </div>
                  <span className="text-xs font-medium uppercase tracking-wider text-slate-400 bg-slate-100 px-3 py-1.5 rounded-full">
                    {project.tag}
                  </span>
                </div>
                ...
                <div className="mt-6 flex items-center text-blue-600 font-medium text-sm opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
      ...
      <AnimatedWrapper animation="fade-up" delay="300ms" className="text-center mt-20">
        <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-blue-700 to-purple-600 p-10 sm:p-14 rounded-3xl shadow-2xl shadow-blue-600/20 text-white noise-overlay">
          <div className="relative z-10">
            <h3 className="text-2xl sm:text-3xl font-bold mb-4">Ready to Start Your Project?</h3>
            <p className="text-lg sm:text-xl mb-8 text-blue-100 max-w-xl mx-auto">
              Let's discuss how we can bring your vision to life with cutting-edge technology.
            </p>
            <button 
              onClick={onContactClick}
              className="bg-white text-blue-700 px-8 py-3.5 rounded-full font-semibold hover:bg-blue-50 transition-all duration-300 hover:scale-105 hover:-translate-y-0.5 shadow-xl text-base inline-flex items-center gap-2"
            >
              Get Started Today
