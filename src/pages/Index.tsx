...
const Index = () => {
  ...
  return (
    <div className="min-h-screen hero-gradient">
      ...
      <main>
        <section ref={heroRef} className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden relative" aria-label="AI Software Development Agency Hero">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <AnimatedWrapper animation="fade-up">
              <div className="flex justify-center items-center gap-2 mb-6">
                ...
                <span className="text-sm sm:text-base font-medium text-blue-600 uppercase tracking-wider">🏆 #1 AI Software Development Agency</span>
                <Sparkles className="h-5 w-5 sm:h-6 sm:w-6 text-purple-600 animate-pulse" style={{animationDelay: '0.5s'}} aria-hidden="true" />
              </div>
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-light text-slate-800 mb-6 leading-tight">
                <span className="font-semibold text-transparent bg-gradient-to-r from-blue-600 to-teal-400 bg-clip-text">Custom AI Solutions.</span><br />
                <span className="font-semibold text-transparent bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text">GPT Integration.</span><br />
                <span className="font-semibold text-transparent bg-gradient-to-r from-blue-600 to-teal-400 bg-clip-text">Business Automation.</span>
              </h1>
            </AnimatedWrapper>
            ...
            <AnimatedWrapper animation="fade-up" delay="200ms">
              <div className="relative">
                <p className="text-xl sm:text-2xl text-slate-600 mb-6 max-w-3xl mx-auto leading-relaxed">
                  🚀 Transform your business with <strong>intelligent AI applications</strong>, <strong>GPT integrations</strong>, and <strong>cutting-edge automation</strong> that drive real results.
                </p>
                <div className="flex flex-wrap justify-center gap-2 mb-6 text-sm">
                  <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full font-medium">GPT Integration</span>
                  <span className="bg-purple-100 text-purple-800 px-3 py-1 rounded-full font-medium">Machine Learning</span>
                  <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full font-medium">AI Automation</span>
                  <span className="bg-orange-100 text-orange-800 px-3 py-1 rounded-full font-medium">Custom Development</span>
                </div>
              </div>
            </AnimatedWrapper>
            ...
            <AnimatedWrapper animation="fade-up" delay="400ms">
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center mb-8">
                <Button
                  ...
                  aria-label="Get free AI consultation from Calcera Global experts"
                >
                ...
                <Button
                  ...
                  aria-label="View Calcera Global's AI portfolio and case studies"
                >
            ...
            <AnimatedWrapper animation="fade-up" delay="600ms">
              <div className="relative bg-white/60 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg border border-white/20 max-w-3xl mx-auto">
                <h2 className="text-base sm:text-lg text-slate-600 font-semibold leading-relaxed mb-3">
                  💡 Why Choose Calcera Global for Your AI Development?
                </h2>
                <p className="text-sm sm:text-base text-slate-600 leading-relaxed mb-4">
                  We're not just another <strong>AI software development agency</strong>. We specialize in building <strong>GPT-powered applications</strong>, <strong>intelligent automation systems</strong>, and <strong>custom AI solutions</strong> that actually solve business problems and generate ROI.
                </p>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs sm:text-sm">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-slate-600">Development Support</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-orange-600">Free</div>
                    <div className="text-slate-600">Consultation</div>
                  </div>
                </div>
              </div>
            </AnimatedWrapper>
        ...
        <section ref={servicesRef} aria-label="AI development services and solutions">
          <ServicesGrid />
        </section>
        
        <section ref={workRef} aria-label="AI portfolio and case studies">
          <PortfolioGrid onContactClick={() => scrollToSection(contactRef)} />
        </section>
        
        <section aria-label="Why choose Calcera Global as your AI development partner">
          <WhyChooseUs />
        </section>
        
        <section ref={contactRef} aria-label="Contact Calcera Global for AI development services">
          <ContactForm />
        </section>
      </main>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-4 mb-6">
                <img 
                  ...
                  alt="Calcera Global - Leading AI Software Development Agency Logo" 
                ...
                <div>
                  ...
                  <p className="text-slate-300">🏆 #1 AI Development Partner</p>
                </div>
              </div>
              <p className="text-slate-300 text-lg leading-relaxed mb-6">
                Leading <strong>AI software development agency</strong> specializing in <strong>GPT integration</strong>, <strong>intelligent automation</strong>, and <strong>custom AI solutions</strong> that drive measurable business results for companies worldwide.
              </p>
              <div className="flex space-x-4">
                <a 
                  href="https://www.linkedin.com/company/calcera.global/" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="bg-blue-600 hover:bg-blue-700 p-3 rounded-full transition-all duration-300 hover:scale-110"
                  aria-label="Connect with Calcera Global on LinkedIn for AI development insights"
                >
                ...
                <a 
                  href="https://www.instagram.com/calcera.global?igsh=MW9saW5mZjJsZHozdg==" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="bg-pink-600 hover:bg-pink-700 p-3 rounded-full transition-all duration-300 hover:scale-110"
                  aria-label="Follow Calcera Global on Instagram for AI development showcase"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div>
              ...
              <nav aria-label="AI development services navigation">
                <ul className="space-y-3">
                  {["GPT Integration", "AI Automation", "Custom AI Apps", "Machine Learning", "AI Consulting"].map(item => (
                    <li key={item}>
                      <a
                        href="#"
                        onClick={(e) => {
            ...
            <div>
              ...
              <ul className="space-y-3 text-slate-300">
                <li><a href="#" onClick={(e) => { e.preventDefault(); scrollToSection(workRef); }} className="hover:text-white transition-colors">Portfolio</a></li>
                <li><a href="#" onClick={(e) => { e.preventDefault(); scrollToSection(contactRef); }} className="hover:text-white transition-colors">Contact</a></li>
                <li className="cursor-default">Free Consultation</li>
                <li className="cursor-default">24/7 Support</li>
              </ul>
            </div>
          </div>
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
              <div className="text-slate-300 text-center lg:text-left">
                <p className="text-lg font-medium">
                  &copy; 2025 Calcera Global. Leading AI Software Development Agency.
                </p>
                <p className="text-sm mt-1">
                  Transforming businesses through <strong>intelligent AI solutions</strong> and <strong>GPT integration</strong>.
                </p>
              </div>
