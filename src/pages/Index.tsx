        ...
        <section ref={heroRef} className="relative min-h-[90dvh] flex items-center pt-32 sm:pt-40 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden mesh-gradient noise-overlay" aria-label="Hero section">
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            <AnimatedWrapper animation="fade-up" delay="400ms" className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-16 px-4">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-2xl text-sm font-bold shadow-2xl shadow-blue-600/25 hover:shadow-blue-600/40 transition-all duration-500 hover:-translate-y-1 active:translate-y-0 group shimmer-btn"
              ...
              <Button
                variant="outline"
                size="lg"
                className="w-full sm:w-auto bg-white/20 border-2 border-slate-200 px-6 sm:px-8 py-3 sm:py-4 rounded-2xl text-sm font-semibold hover:bg-slate-50 transition-all duration-300"
        ...
        <section aria-label="Meet the team" className="py-24 sm:py-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            ...
            <AnimatedWrapper animation="fade-up" delay="200ms" className="flex justify-center">
              <Link to="/about">
                <Button className="bg-slate-900 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-2xl text-sm font-bold shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 active:translate-y-0 group">
                  Meet the Core Team
